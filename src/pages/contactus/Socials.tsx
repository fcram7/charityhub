  ...
  return ( 
    <section className="socials-section px-[5%] lg:px-[2%] py-36 bg-slate-200">
      ...
      <div className="socials-content mt-4 lg:mt-8 flex justify-center items-center gap-6 lg:gap-8">
        <div className="socials text-7xl lg:text-8xl text-red-600">
          <a href="#">
            <FaYoutube />
          </a>
        </div>
        <div className="socials text-6xl lg:text-7xl text-slate-50 rounded-xl bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045]">
          <a href="#">
            <FaInstagram />
          </a>
        </div>
